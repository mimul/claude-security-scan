...
| 영역 | 추천 수단 |
|------|---------|
| 아키텍처/비즈니스 로직 수준 취약점 | [소프트웨어 보안의 철학, 전략, 원칙](https://www.mimul.com/blog/ai-security-rule/)을 기반으로 <br/> 해당 프로젝트에서 사용하는 언어에 특성을 가미한 [security-style.md](https://github.com/mimul/axum-rusty/blob/main/.claude/rules/rust-security-style.md) 파일을 rules에 적용해서 코드 리뷰, 리팩토링에서 활용해서 보완 필요|
| 비즈니스 로직 결함 | 침투 테스트 |
